...
function calc(){
    ...
    function initLocalettings(selector, activeClass){
    ...
    initLocalettings('#gender div', 'calculating__choose-item_active');
    initLocalettings('.calculating__choose_big div', 'calculating__choose-item_active');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({container, slide, nextArrow, prevArrow, totalCaunter, carentCounter, wrapper, field}){
     // //Slider variant1  //////////////////////////////
    ...
    const slides = document.querySelectorAll(slide),
          ...
          current = document.querySelector(carentCounter),
...
/* harmony import */ var _modules_cals__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/cals */ "./js/modules/cals.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const modalTimer = setInterval(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.showModal)('.modal', modalTimer), 10000);
    ...
    (0,_modules_cals__WEBPACK_IMPORTED_MODULE_4__.default)();
